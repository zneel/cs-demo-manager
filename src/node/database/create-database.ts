import type { PostgresqlDatabaseSettings } from 'csdm/node/settings/settings';
import { executePsql } from './psql/execute-psql';
import { formatHostnameForUri } from './format-hostname-for-uri';

export async function createDatabase(databaseSettings: PostgresqlDatabaseSettings) {
